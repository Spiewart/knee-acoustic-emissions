...
class TestAudioQCFieldsDatabasePersistence:
    ...
    def _create_audio_processing_with_qc(self) -> AudioProcessing:
        ...
        return AudioProcessing(
            ...
            qc_artifact_type_ch2=["Intermittent"],
            qc_artifact_segments_ch2=[(12.0, 14.0)],
    ...
    def test_create_audio_processing_record_includes_artifact_qc(self):
        ...
        assert hasattr(AudioProcessingRecord, "qc_artifact_segments_ch1")
        assert hasattr(AudioProcessingRecord, "qc_artifact_ch2")
        assert hasattr(AudioProcessingRecord, "qc_artifact_type_ch2")
        assert hasattr(AudioProcessingRecord, "qc_artifact_segments_ch2")
        assert hasattr(AudioProcessingRecord, "qc_artifact_ch3")
        assert hasattr(AudioProcessingRecord, "qc_artifact_type_ch3")
        assert hasattr(AudioProcessingRecord, "qc_artifact_segments_ch3")
        assert hasattr(AudioProcessingRecord, "qc_artifact_ch4")
        assert hasattr(AudioProcessingRecord, "qc_artifact_type_ch4")
        assert hasattr(AudioProcessingRecord, "qc_artifact_segments_ch4")
