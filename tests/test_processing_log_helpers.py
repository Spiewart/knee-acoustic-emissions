...
class TestGetAudioProcessingQCDefaults:
    ...
    def test_returns_all_required_qc_fields(self):
        ...
        assert "qc_signal_dropout_overall" in defaults
        ...
        assert "qc_artifact_overall" in defaults
    ...
    def test_dropout_flags_are_false(self):
        ...
        defaults = _get_audio_processing_qc_defaults()
        assert defaults["qc_signal_dropout_overall"] is False
    ...
    def test_artifact_flags_are_false(self):
        ...
        defaults = _get_audio_processing_qc_defaults()
        assert defaults["qc_artifact_overall"] is False
...
class TestGetSyncMethodDefaults:
    ...
    def test_returns_sync_method_fields(self):
        """Test that helper returns sync method related fields."""
        defaults = _get_sync_method_defaults()
...
class TestCreateAudioRecordHelpers:
    ...
    def test_qc_data_integration(self):
        ...
        qc_data = {
            ...
            "qc_signal_dropout_overall": True,
        ...
        assert "qc_signal_dropout_overall" in qc_data
        assert qc_data["qc_signal_dropout_overall"] is True
    ...
    def test_qc_data_missing_uses_defaults(self):
        ...
        assert merged["qc_signal_dropout_overall"] is False  # From defaults
...
class TestMovementCycleCreation:
    ...
    def test_movement_cycle_creation_with_defaults(self):
        ...
        assert cycle.qc_signal_dropout_overall is False
        assert cycle.qc_artifact_overall is False
