...
class TestProcessingLogIntegration:
    ...
    def test_incremental_update_preserves_existing_data(self, tmp_path):
        ...
        synced_data = [
            (output_path, synced_df, (10.5, 5.2, 5.1))
        ]
        ...
        assert loaded_log.synchronization_records[0].audio_stomp_time == 10.5
    ...
    def test_log_survives_multiple_updates(self, tmp_path):
        ...
        synced_data_updated = [
            (
                ...
                (11.0, 5.5, 5.4)  # Different stomp times
            )
        ]
        _save_or_update_processing_log(
            study_id="1011",
        ...
        assert loaded_log.synchronization_records[0].audio_stomp_time == 11.0
        assert loaded_log.synchronization_records[0].num_synced_samples == 100
    ...
    def test_get_or_create_behavior(self, tmp_path):
        ...
        # Create initial log
        log1 = ManeuverProcessingLog.get_or_create(
            study_id="1011",
            knee_side="Left",
            maneuver="walk",
        ...
        log1.update_audio_record(audio)
        log1.save_to_excel()
        ...
        assert log2.audio_record.audio_file_name == "original_audio"
